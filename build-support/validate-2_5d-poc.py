...
debug_manifest = read("android/app/src/debug/AndroidManifest.xml")
debug_trigger = read("android/app/src/debug/java/kr/co/re/subscription/payment/PocPaymentTriggerActivity.java")
require(debug_manifest, "PocPaymentTriggerActivity", "debug E2E trigger Activity")
require(debug_manifest, 'android:exported="true"', "debug trigger export")
require(debug_trigger, "PaymentDetectionCoordinator.handle", "debug trigger -> coordinator")
require(debug_trigger, "KnownSubscriptionSnapshotStore.syncEmptyForPoc", "debug new-subscription fixture")
require(debug_trigger, "POC_RESULT", "debug trigger evidence log")
