...
poc_trigger = read("android/app/src/main/java/kr/co/re/subscription/payment/PocPaymentTriggerActivity.java")
require(manifest, "PocPaymentTriggerActivity", "PoC E2E trigger Activity")
require(manifest, 'android:exported="true"', "PoC trigger export")
require(poc_trigger, "PaymentDetectionCoordinator.handle", "PoC trigger -> coordinator")
require(poc_trigger, "KnownSubscriptionSnapshotStore.syncEmptyForPoc", "PoC new-subscription fixture")
require(poc_trigger, "POC_RESULT", "PoC trigger evidence log")
