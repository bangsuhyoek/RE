    ...
    <main className="re-onboarding relative min-h-screen overflow-hidden pb-32">
      ...
      <div className="relative z-10">
        ...
        <section className="px-5">
          ...
          <p className="mt-3 text-[14px] leading-6 text-[#71717A]">서비스만 먼저 골라두면 금액·결제일·결제수단은 다음 단계에서 직접 확인해요. 사용자 확인 전에는 임의의 구독 정보를 만들지 않아요.</p>
        </section>
      ...
      <div className="fixed bottom-0 left-1/2 z-30 w-full max-w-[420px] -translate-x-1/2 border-x border-t border-[#E4E4E7] bg-white/95 px-5 pb-[max(1rem,env(safe-area-inset-bottom))] pt-3 backdrop-blur-xl">
