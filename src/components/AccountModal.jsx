...
export function AccountModal({
  ...
  return (
    <BottomSheet onClose={handleAccountClose} label="계정 설정">
      ...
      {/* 꾸독 공식 캐릭터: 사용자 변경 없이 master asset 1종만 사용 */}
      <div className="mt-3 flex min-h-[72px] w-full items-center justify-between rounded-2xl border border-[#E5E8EB] bg-white px-3.5 py-3 shadow-2xs">
        <div>
          <span className="block text-[13px] font-bold text-[#191F28]">꾸독 캐릭터</span>
          <span className="mt-0.5 block text-[11px] text-[#8B95A1]">
            서비스 전체에서 동일한 공식 캐릭터를 사용해요.
          </span>
        </div>
        <span className="grid h-14 w-14 shrink-0 place-items-center overflow-hidden rounded-2xl bg-[#F2F4F6] p-1.5">
          <img
