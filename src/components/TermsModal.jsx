...
3. 실시간 결제 감지 및 퀵 등록: 카드사/간편결제 알림 수신 시 구독 등록 후보를 제시하고 저장 전 회원이 확인
4. 영수증 이미지 인식 및 결제 문자 파싱: 영수증 사진은 AI OCR로 읽고, 결제 문자는 규칙 기반 파싱으로 입력을 보조
